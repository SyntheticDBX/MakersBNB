...
describe Application do
  ...
  context 'POST /signup' do
    it "adds new user and returns /login" do
      response = post('/signup', first_name: "first", last_name: "last", username: "firlas", email: "user@makersbnb.com", password: "CorrectPassword123")
      expect(response.status).to eq(200)
  ...
  context 'GET listing/:id' do
    xit 'displays listing ID 2s page' do
