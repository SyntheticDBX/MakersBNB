...
INSERT INTO public.users ("first_name", "last_name", "username", "email_address", "password", "user_created_date")
values ('Abdel', 'Andresen', 'aandresen2', 'abdel@email.com', 'rEq1Zb', '2022-10-10T12:54:27Z');
INSERT INTO public.users ("first_name", "last_name", "username", "email_address", "password", "user_created_date")
values ('Lindsay', 'Housbey', 'lhousbey3', 'lindsay@email.com', 'QrIZrUIz96w', '2022-01-21T01:07:31Z');
INSERT INTO public.users ("first_name", "last_name", "username", "email_address", "password", "user_created_date")
values ('Alane', 'Fraser', 'afraser4', 'alane@email.com', 'SgG7jv', '2022-04-10T10:33:06Z');

INSERT INTO public.spaces ("user_id", "name", "first_line_address", "second_line_address", "city", "country",
                           "postcode",
                           "description", "space_created_date","dates_available" , "price_per_night")
values (1, 'Cottage house', '69 Lakewood Road', 'Apt 460', 'Udon Thani', 'Thailand', '10310',
        ...
        '2022-05-26T03:56:00Z', '2023-01-18,2023-01-19,2023-01-20,2023-01-21,2023-01-22' , 80);
INSERT INTO public.spaces ("user_id", "name", "first_line_address", "second_line_address", "city", "country",
                           "postcode",
                           "description", "space_created_date","dates_available" ,"price_per_night")
values (2, 'Treehouse', '6 Monterey Plaza', 'PO Box 19601', 'Zruč nad Sázavou', 'Czech Republic', '285 22',
        ...
        '2022-05-15T23:17:27Z', '2023-01-18,2023-01-19,2023-01-20,2023-01-21,2023-01-22' , 85);
INSERT INTO public.spaces ("user_id", "name", "first_line_address", "second_line_address", "city", "country",
                           "postcode",
                           "description", "space_created_date","dates_available", "price_per_night")
values (3, '2-bedroom flat', '6 Bonner Crossing', 'Apt 124', 'Sindangan', 'Philippines', '6305',
        ...
        '2022-05-14T06:13:24Z','2023-01-18,2023-01-19,2023-01-20,2023-01-21,2023-01-22', 90);
INSERT INTO public.spaces ("user_id", "name", "first_line_address", "second_line_address", "city", "country",
                           "postcode",
                           "description", "space_created_date","dates_available", "price_per_night")
values (4, '1-bedroom bungalow', '7 Lien Crossing', '3rd Floor', 'Na Tan', 'Thailand', '37180',
        ...
        '2022-05-07T04:26:59Z','2023-01-18,2023-01-19,2023-01-20,2023-01-21,2023-01-22', 55);
INSERT INTO public.spaces ("user_id", "name", "first_line_address", "second_line_address", "city", "country",
                           "postcode",
                           "description", "space_created_date","dates_available", "price_per_night")
values (5, '1-bedroom flat', '38718 Sachs Way', 'Apt 862', 'Tessaoua', 'Niger', '74291',
        ...
        '2022-09-20T01:49:37Z','2023-01-18,2023-01-19,2023-01-20,2023-01-21,2023-01-22', 60);
